	...
	var Core = {
			...
			filter: function () {
				...
				if ($filter.length) {
					$filter.on("click", "a", function () {
						...
						if (filterValue != "*")
							$list.children().not(filterValue).addClass("not-matched");
		...
		Component: {
			...
			map: function () {
				...
				if ($googleMap.length) {
					var yourLatitude = 6.5095;
					var yourLongitude = 3.3711;
						...
						if (!$target.hasClass("show")) {
							...
							el.stop().animate(
								...
								function () {
									el.stop().animate(
										{
											path: "M 0 0 C 620 0, 1300 0, 1920 0 L 1920 1080 L 0 1080 Z"
										},
										1200,
										mina.elastic
									);
							...
							setTimeout(function () {
								el.stop()
									.animate(
										{
											path: "M 0 0 C 620 220, 1300 220, 1920 0 L 1920 1080 L 0 1080 Z"
										},
										300,
										mina.linear
									)
